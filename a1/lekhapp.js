...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5335664,
    DYNAMIC_BASE = 5335664,
    DYNAMICTOP_PTR = 92528;
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=92576;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var ___tm_current=92624;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 92672, 4), 92672);
