...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5330512,
    DYNAMIC_BASE = 5330512,
    DYNAMICTOP_PTR = 87376;
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=87424;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var ___tm_current=87472;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 87520, 4), 87520);
