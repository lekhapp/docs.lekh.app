...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5335760,
    DYNAMIC_BASE = 5335760,
    DYNAMICTOP_PTR = 92624;
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=92672;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var ___tm_current=92720;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 92768, 4), 92768);
